...
namespace SDL2
{
	public static class SDL
	{
		...
		public static SDL_bool SetHint(string name, string value)
		{
		...
		public static SDL_bool SetHintWithPriority(
			string name,
			string value,
			SDL_HintPriority priority
		) {
		...
		public static SDL_bool GetHintBoolean(
			string name,
			SDL_bool default_value
		) {
		...
		*/
		...
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SDL_LogPriority")]
        public static extern SDL_LogPriority LogGetPriority(
			int category
		);
